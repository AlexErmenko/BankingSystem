	...
	internal class ApplicationDbContextModelSnapshot : ModelSnapshot
	{
		protected override void BuildModel(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
			{
				...
				b.Property<string>("Name").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);

				b.Property<string>("NormalizedName").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);
			...
			modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
			{
				...
				b.Property<string>("Email").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);
				...
				b.Property<string>("NormalizedEmail").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);

				b.Property<string>("NormalizedUserName").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);
				...
				b.Property<string>("UserName").HasColumnType("nvarchar(256)").HasMaxLength(maxLength: 256);
			...
			{
				b.Property<string>("LoginProvider").HasColumnType("nvarchar(128)").HasMaxLength(maxLength: 128);

				b.Property<string>("ProviderKey").HasColumnType("nvarchar(128)").HasMaxLength(maxLength: 128);
			...
			modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserToken<string>", b =>
			{
				...
				b.Property<string>("Name").HasColumnType("nvarchar(128)").HasMaxLength(maxLength: 128);
			...
			modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
			{
				b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole", navigationName: null).WithMany()
				 .HasForeignKey("RoleId").OnDelete(DeleteBehavior.Cascade).IsRequired();

				b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", navigationName: null).WithMany()
