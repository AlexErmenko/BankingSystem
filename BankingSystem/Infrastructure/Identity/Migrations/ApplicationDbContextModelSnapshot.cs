...
#pragma warning disable 612, 618
			modelBuilder.HasAnnotation(annotation: "ProductVersion", value: "3.0.0")
			...
			modelBuilder.Entity(name: "Microsoft.AspNetCore.Identity.IdentityUser", buildAction: b =>
			{
				b.Property<string>(propertyName: "Id").HasColumnType(typeName: "nvarchar(450)");
				...
				b.Property<string>(propertyName: "UserName").HasColumnType(typeName: "nvarchar(256)").HasMaxLength(maxLength: 256);
			...
			{
				b.Property<string>(propertyName: "LoginProvider").HasColumnType(typeName: "nvarchar(128)").HasMaxLength(maxLength: 128);

				b.Property<string>(propertyName: "ProviderKey").HasColumnType(typeName: "nvarchar(128)").HasMaxLength(maxLength: 128);
			...
			modelBuilder.Entity(name: "Microsoft.AspNetCore.Identity.IdentityUserToken<string>", buildAction: b =>
			{
				...
				b.Property<string>(propertyName: "Name").HasColumnType(typeName: "nvarchar(128)").HasMaxLength(maxLength: 128);
			...
			modelBuilder.Entity(name: "Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", buildAction: b =>
			{
				b.HasOne(relatedTypeName: "Microsoft.AspNetCore.Identity.IdentityUser", navigationName: null).WithMany().HasForeignKey("UserId").OnDelete(deleteBehavior: DeleteBehavior.Cascade).IsRequired();
			});
