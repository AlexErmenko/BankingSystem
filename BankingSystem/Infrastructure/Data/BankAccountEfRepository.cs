...
namespace Infrastructure.Data
{
  public class BankAccountEfRepository : IBankAccountRepository
  {
    ...
    public async Task SaveAccount(BankAccount account)
    {
      ...
      {
        BankAccount bankAccount = await _context.BankAccounts.FirstAsync(predicate: s => s.Id == account.Id);
    ...
    {
      BankAccount bankAccount = await _context.BankAccounts.FirstAsync(predicate: account => account.Id == idAccount);
