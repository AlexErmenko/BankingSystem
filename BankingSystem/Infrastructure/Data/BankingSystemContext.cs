...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=MSI\\MSSQLSERVER2017;Initial Catalog=banking_system;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Accrual>(entity =>
            {
                ...
                entity.ToTable("accrual");

                entity.Property(e => e.IdAccrual)
                    .HasColumnName("id_accrual")
                    .ValueGeneratedNever();
                ...
                entity.Property(e => e.DateAccrual)
                    .HasColumnName("date_accrual")
                    .HasColumnType("date");
            ...
            modelBuilder.Entity<Repayment>(entity =>
            {
                ...
                entity.Property(e => e.IdRepayment).HasColumnName("id_repayment");

                entity.Property(e => e.Amount)
                    .HasColumnName("amount")
                    .HasColumnType("decimal(10, 2)");

                entity.Property(e => e.DateRepayment)
                    .HasColumnName("date_repayment")
                    .HasColumnType("date");
