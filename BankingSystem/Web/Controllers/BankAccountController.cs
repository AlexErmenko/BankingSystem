...
namespace Web.Controllers
{
  ...
  public class BankAccountController : Controller
  {
    ...
    public async Task<IActionResult> CreateClientAccountForm(int? idClient)
    {
      ...
      PhysicalPerson physicalPerson = await _physicalPersonRepository.GetById(id: idClient);
      LegalPerson legalPerson = await _legalPersonRepository.GetById(id: idClient);
    ...
    public IActionResult CreateClientAccountForm(CreateClientAccountViewModel createClientAccountViewModel)
    {
      ...
      {
        //сохранение счета
        BankAccount account = createClientAccountViewModel.Account;
    ...
    public async Task<IActionResult> GetAccounts(int? idClient)
    {
      ...
      IQueryable<BankAccount> accounts = _bankAccountRepository.Accounts.Include(navigationPropertyPath: p => p.IdCurrencyNavigation).Where(predicate: c => c.IdClient == idClient);
